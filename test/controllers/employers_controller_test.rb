...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { birth: @employer.birth, email: @employer.email, lastname: @employer.lastname, name: @employer.name, phone: @employer.phone }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { birth: @employer.birth, email: @employer.email, lastname: @employer.lastname, name: @employer.name, phone: @employer.phone }
    assert_redirected_to employer_path(assigns(:employer))
  end
